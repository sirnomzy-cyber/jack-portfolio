...
const AboutSection = () => {
  return (
    <section
      id="about"
      className="relative flex min-h-screen flex-col items-center justify-center px-5 py-20 sm:px-8 sm:py-24 md:px-12 md:py-28"
    >
      ...
      >
        <img
          ...
          alt="Decorative 3D group of objects"
          className="w-full"
        />
      </FadeIn>

      <div className="flex flex-col items-center gap-10 text-center sm:gap-12 md:gap-14">
        <FadeIn delay={0} y={40}>
          <h2
